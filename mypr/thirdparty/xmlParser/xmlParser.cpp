 ...
 * Commercialized by <a
 *href="http://www.Business-Insight.com">Business-Insight</a>
...
#else
#include <wctype.h>
// for gcc/non-linux (MacOS X 10.3, FreeBSD 6.0, NetBSD 3.0, OpenBSD 3.8, AIX
// 4.3.2, HP-UX 11, IRIX 6.5, OSF/1 5.1, Cygwin, mingw)
static inline int xstricmp(XMLCSTR c1, XMLCSTR c2) {
  wchar_t left, right;
  do {
    left = towlower(*c1++);
...
// inside a tag
typedef enum XMLStatus { eInsideTag = 0, eOutsideTag } XMLStatus;
